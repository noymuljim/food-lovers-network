...
const Login = () => {
    ...
    const { signinUser, google ,forgetPassword} = use(AuthContext)
                ...
                <div className='flex flex-col md:flex-row justify-between items-center md:items-start gap-8'>
                    ...
                    <div>
                        <div className='flex justify-center items-center gap-4'>
                            ...
                            <img className='h-[100px] w-[100px]' src={chiken} alt="" />
                        </div>
                        <h1 className='font-bold text-3xl text-center'>Login and start sharing your foodie <br />adventures today!</h1>
                    </div>
